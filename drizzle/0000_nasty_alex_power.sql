...
CREATE TABLE "courses" (
	...
	"duracion_horas" text DEFAULT '' NOT NULL,
...
CREATE TABLE "user" (
	...
	CONSTRAINT "user_role_check" CHECK ("user"."role" in ('admin', 'instructor', 'estudiante')),
...
ALTER TABLE "scholarships" ADD CONSTRAINT "scholarships_beneficiario_user_id_user_id_fk" FOREIGN KEY ("beneficiario_user_id") REFERENCES "public"."user"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
